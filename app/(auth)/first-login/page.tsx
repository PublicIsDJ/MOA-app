...
import type { FirstLoginFormState } from "@/features/auth/login/types";
import { InitialFirstLogin } from "@/features/auth/login/types";
import {
  mapAgeToBackend,
...
import type { age, features, gender } from "@/types";
...
export default function FirstLoginPage() {
  ...
  const [formData, setFormData] =
    useState<FirstLoginFormState>(InitialFirstLogin);
  ...
  const handleComplete = async () => {
    ...
    try {
      ...
      const fallbackMessage = "프로필 저장에 실패했습니다. 다시 시도해주세요.";
      setError(
  ...
  return (
    ...
    <div className="min-h-dvh flex flex-col bg-white">
      ...
      {/* MARK: 환영 메시지 */}
      {currentStep === 1 && (
        <section id="welcom-01" className="flex flex-1 flex-col px-5 pb-8">
      ...
      {/* MARK : 성별과 나이 */}
      {currentStep === 2 && (
        <section id="welcom-02" className="flex flex-1 flex-col px-5 pb-8">
          <div className="flex-1 overflow-y-auto">
            ...
            <div className="w-full pb-6">
              {/* MARK: 성별 선택 */}
              <h1 className="text-base font-bold text-gray-900 mt-6 mb-3">
                성별
              </h1>
              ...
              {/* MARK: 나이 선택 */}
              <h1 className="text-base font-bold text-gray-900 mt-[30px] mb-3">
                나이
              </h1>
      ...
      {/* MARK : 관심 영역 선택 */}
      {currentStep === 3 && (
        <section id="welcome-03" className="flex flex-1 flex-col px-5 pb-8">
          <div className="flex-1 overflow-y-auto">
